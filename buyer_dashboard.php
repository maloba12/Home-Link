...
// Properties viewed (from search history if implemented)
$stats['properties_viewed'] = 0; // Placeholder
...
// Get recommended properties (simple recommendation based on saved properties)
$recommendedStmt = $pdo->prepare("SELECT DISTINCT p.*, u.username as seller_name,
                                  (SELECT image_url FROM images WHERE property_id = p.property_id AND is_primary = TRUE LIMIT 1) as primary_image
                                  FROM properties p
                                  JOIN users u ON p.seller_id = u.user_id
                                  WHERE p.status = 'approved'
                                  AND p.property_id NOT IN (SELECT property_id FROM favorites WHERE user_id = ?)
...
<div class="dashboard-container">
    ...
    <div class="quick-actions">
        ...
        <div class="action-buttons-grid">
            ...
            <a href="/my_favorites.php" class="action-btn btn-danger">
                <i class="fas fa-heart"></i>
                <span>My Favorites</span>
            </a>
            <a href="/my_bookings.php" class="action-btn btn-success">
    ...
    <div class="dashboard-section">
        <div class="section-header">
            ...
            <a href="/my_favorites.php" class="btn btn-sm btn-primary">View All</a>
        </div>
