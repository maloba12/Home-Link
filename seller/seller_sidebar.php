...
<aside class="seller-sidebar">
    <ul class="sidebar-menu">
        ...
        <li>
            <a href="my_properties.php" class="<?php echo $currentPage === 'my_properties.php' ? 'active' : ''; ?>">
                <i class="fas fa-building"></i>
                <span>My Properties</span>
            </a>
        </li>
        <li>
            <a href="upload_property.php" class="<?php echo $currentPage === 'upload_property.php' ? 'active' : ''; ?>">
